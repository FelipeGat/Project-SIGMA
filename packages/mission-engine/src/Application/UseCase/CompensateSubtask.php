...
final class CompensateSubtask
{
    ...
    public function execute(MissionId $missionId, SubtaskId $subtaskId, string $action, bool $succeeded, \DateTimeImmutable $now): Mission
    {
        ...
        $mission->compensateSubtask($subtaskId, $action, $succeeded, $now);
