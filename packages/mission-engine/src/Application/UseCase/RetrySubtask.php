...
final class RetrySubtask
{
    ...
    public function execute(MissionId $missionId, SubtaskId $subtaskId, string $reason, \DateTimeImmutable $now): Mission
    {
        ...
        $mission->retrySubtask($subtaskId, $reason, $now);
