...
final class ValidateSubtask
{
    ...
    public function execute(MissionId $missionId, SubtaskId $subtaskId, mixed $result): Mission
    {
        ...
        $mission->validateSubtask($subtaskId, $result);
