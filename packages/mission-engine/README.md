...
Release 5 do [ROADMAP.md](../../ROADMAP.md), depende só de `core`/`kernel`. `Domain/` completo desde a Release 5B; `Application/`/`Infrastructure/`/`Interfaces/` desde a Release 5C — ver [Decision Log 5C](../../docs/releases/0005c-mission-infrastructure-decision-log.md).
