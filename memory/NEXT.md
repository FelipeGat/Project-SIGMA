...
0. **BLOQUEIO ATIVO — [Proposal 6B (Planner Implementation)](../docs/releases/0006b-planner-implementation.md) aguarda aprovação explícita do Product Owner.** Toda a modelagem da 6A está aprovada e commitada; nenhum código do Planner pode ser escrito antes desse aval (princípio inegociável nº 12). **Ponto que merece atenção antes de aprovar**: ao fim da 6B, nada consumirá `mission.planned` — o Mission Engine ainda não assina evento nenhum (constatado na 5C). O Planner vai publicar corretamente e nenhuma Mission nascerá disso. Está declarado como fora de escopo e como Risco 1 da Proposal; fechar o ciclo é a Release 6C. Vale decidir conscientemente se 6B e 6C devem ser uma só.
