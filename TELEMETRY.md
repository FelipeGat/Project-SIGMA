...
Bootstrap de Telemetry pertence ao [Kernel](KERNEL.md). Persistência e consulta de Audit pertencem a [packages/audit-engine](packages/audit-engine/). Dashboards consumindo essa base pertencem à Release 13 — Analytics do [ROADMAP.md](ROADMAP.md).
