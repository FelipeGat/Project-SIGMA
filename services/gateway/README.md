...
Vazio na Fase Foundation. Cresce em conjunto com cada Engine implementado a partir da Release 2 — SIGMA Bootstrap do [ROADMAP.md](../../ROADMAP.md) — o gateway expõe cada Engine à medida que ele existe, não de uma vez.
