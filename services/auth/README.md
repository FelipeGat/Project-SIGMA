...
Vazio na Fase Foundation. Fundações de Tenant/Company/Workspace/Role entram já na Release 2 — Kernel do [ROADMAP.md](../../ROADMAP.md), mesmo que a superfície completa de auth amadureça depois.
