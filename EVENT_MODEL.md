...
| **Business** | Marcos curados, com nome de negócio, para consumo por Analytics — geralmente derivados de um ou mais eventos Semantic | Automation Engine, Analytics (Release 13) | `BudgetApproved`, `ClientCreated`, `MeetingFinished` |
