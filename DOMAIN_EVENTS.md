...
| `MemoryReactivated` | `memory.reactivated` | Um `MemoryRecord` `Deprecated` volta a `Active` por ser reforçado sem nova contradição | `memoryRecordId`, `subjectKey` |
