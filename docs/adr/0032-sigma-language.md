...
- Cria um novo artefato a ser versionado e testado (o mapeamento SGL↔JSON) — trabalho adicional na Release 5 ou 6, quem for construída primeiro segundo a Ordem de Desenvolvimento ([ADR-0031](0031-ordem-runtime-vs-desenvolvimento.md)).
