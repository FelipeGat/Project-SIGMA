...
- Exige uma mecânica de promoção entre níveis (a ser definida em detalhe no épico do Memory Engine, camada L5) — complexidade adicional em troca de Memory ser confiável, não apenas grande.
