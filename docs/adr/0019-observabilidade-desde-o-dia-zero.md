...
- Dashboards e alertas (Release 13 — Analytics) só são possíveis porque a base de dados de Telemetry/Audit já existe desde o início — sem essa decisão, a Release 13 exigiria retrofitar tudo isso primeiro.
