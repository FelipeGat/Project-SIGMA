...
| 3A — Identity Domain | [0003a-identity-domain.md](0003a-identity-domain.md) (revisão 3) | — | — | ✅ Aprovada para implementação — [IDENTITY_MODEL.md](../../IDENTITY_MODEL.md), [IDENTITY_LIFECYCLE.md](../../IDENTITY_LIFECYCLE.md), [DOMAIN_EVENTS.md](../../DOMAIN_EVENTS.md) e `contracts/Identity.contract.yaml` entregues; nenhum código ainda |
| 3B — Identity Infrastructure | [0003b-identity-infrastructure.md](0003b-identity-infrastructure.md) (placeholder) | — | — | ⚪ Não iniciada — Proposal completa só é escrita depois que 3A estiver implementada e validada ([ADR-0060](../adr/0060-release-dividida-em-sub-releases.md)) |
