...
| 4A — Memory Domain | [0004a-memory-domain.md](0004a-memory-domain.md) (revisão 1) | — | — | ⏳ Aguardando aprovação — [MEMORY_MODEL.md](../../MEMORY_MODEL.md), [MEMORY_LIFECYCLE.md](../../MEMORY_LIFECYCLE.md) e `contracts/Memory.contract.yaml` entregues; nenhum código ainda |
| 4B — Memory Infrastructure | [0004b-memory-infrastructure.md](0004b-memory-infrastructure.md) (placeholder) | — | — | ⚪ Não iniciada — Proposal completa só é escrita depois que 4A estiver implementada e validada |
