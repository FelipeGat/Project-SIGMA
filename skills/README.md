...
| [whatsapp.md](whatsapp.md) | WhatsApp Cloud API | Especificada — integração de origem já em produção |
...
A partir da Sprint 0.2, toda Skill é implementada tecnicamente como um **Plugin** carregado dinamicamente pelo Skill Engine — ver [PLUGIN_SYSTEM.md](../PLUGIN_SYSTEM.md) e o manifest correspondente em [/plugins](../plugins/).
